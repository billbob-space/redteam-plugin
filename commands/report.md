...
7. Proposer la checklist de clôture :
...
- Le rapport est généré à partir du template `.tools/share/report-templates/default.md.tmpl`. Pour customiser, copier ce template et passer `--template <path>` au script.
